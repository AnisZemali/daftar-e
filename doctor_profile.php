...
include_once("doctor_profile_info.php");

$sql = "SELECT * from doctor  WHERE doctor_id =" . $_SESSION['doctor_id'];
...
<body>
    ...
    <div class="container light-style flex-grow-1 container-p-y">
        ...
        <form action="doctor_profile_info.php" method="post">
        <fieldset>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input name="username" type="text" class="form-control mb-1"
                                            name="Username" placeholder="<?php echo $user["doctor_username"]; ?>">
                                    </div>
                                    <!-- <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="email" type="text" class="form-control mb-1" name="email" placeholder="<?php echo $user["doctor_email"]; ?>">
                                ...
                                <div class="card-body pb-2">
                                    <div class="form-group">
                                        ...
                                        <textarea name="bio" class="form-control" rows="5" name="bio"
                                            placeholder=<?php echo $user["doctor_bio"]; ?>></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="birthdate class="form-label">Birthdate</label>
                                        <input name="birthdate" placeholder="<?php echo $user["doctor_bd"]; ?>" type="date" class="form-control" name="Birthdate">
                                    </div>
                                    <!-- <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="address" type="text" class="form-control" placeholder="<?php echo $user["doctor_address"]; ?>" name="Country">
                                    </div>


                                    <div class="form-group">
                                        <label for="phone" class="form-label">Phone</label>
                                        <input name="phone" type="text" class="form-control" placeholder="<?php echo $user["doctor_phone"]; ?>" name="Phone">
                                    </div>
