...
$sql = "SELECT  patient_username, patient_email,patient_country FROM patient WHERE patient_id = ?";
                        ...
                        <div class="profile-img">
                            <div class="upload-image">
                                <div class="upload-image-preview">
                                    ...
                                    <h5 style="line-height: 2em;">Dr. <?php echo $doctor["patient_username"]; ?></h5> 
                                    ...
                                    <?php echo $doctor["patient_email"]; ?>
                                    </h6>
                                    <h6 style="line-height: 2.5em; color:black"><?php echo $doctor["patient_country"]; ?></h6>
