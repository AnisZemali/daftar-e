                        ...
                        <div class="col-md-12">
                            <div class="card" style="border:1px solid black;">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            <form action="./insert_blood_pressure/insert_blood.php" method="post"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card" style="border:1px solid black;">
                                ...
                                $query = "SELECT blood_date, blood_rate FROM blood WHERE patient_id = ?"; //You don't need a ; like you do in SQL
