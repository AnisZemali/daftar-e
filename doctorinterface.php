...
<div class="navbar">
		<div class="container navbar-container">
			<a href="DocDashboard.php">
				<img class="logo" src="logo.png" width="150" height="88" alt="DAFTAR-E logo">
			</a>
                        ...
                        <div class="profile-img">
                            <div class="upload-image">
                                <div class="upload-image-preview">
                                    ...
                                    <h5 style="line-height: 2em;">Dr. <?php echo $username; ?></h5> 
                                    ...
                                    <?php echo $doctor_email; ?>
                                    </h6>
                                    <h6 style="line-height: 2.5em; color:black"><?php echo $doctor_address ?></h6>
