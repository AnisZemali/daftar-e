    ...
    <div class="main-body">
        ...
        <div class="container main-body-container">
          <div class="virtual-healthcare-section">
            <div class="virtual-healthcare-section__left">
              <h1 class="virtual-healthcare-section__heading">
                Virtual healthcare for you
              </h1>
              <p class="virtual-healthcare-section__text">
                DAFTAR-E provides progressive, and affordable healthcare,
                accessible on mobile and online for everyone
              </p>
              <a
                class="virtual-healthcare-section__button button-blue"
                href="role.php"
                >Register</a>
              
            </div>
            <img  class="virtual-healthcare-section__img" src="img/trafalgar-app.png"  srcset="img/trafalgar-header-illustration-1.png 1x" srcset="img/trafalgar-header-illustration-1.jpg 2x " width="693" height="598" alt="Doctor and patient are talking to each other.">
          </div>
          <!-- End of virtual-healthcare-section -->
        </div>
        <!-- End of container -->
      </div>
      ...
      <div class="container main-body-container">
        <div class="leading-helthcare">
          <img
            class="leading-helthcare__img"
            src="img/labaratory-injection.png"
            srcset="
              img/labaratory-injection.png    1x,
              img/labaratory-injection@2x.png 2x
            "
            alt="Labaratory and injection"
            width="650"
            height="477"
          />
          <div class="leading-healthcare-right">
            ...
            <p class="leading-helthcare__text">
              DAFTAR-E provides progressive, and affordable healthcare,
              accessible on mobile and online for everyone. To us, it’s not just
              work. We take pride in the solutions we deliver
            </p>
            <a class="leading-helthcare__button button-white" href="#"
              >Learn more</a
            >
          </div>
          <!-- End of leading-healthcare-right -->
        </div>
        <!-- End of leading-helthcare -->
        ...
        <div class="our-services-section">
          <div class="our-services-section-wrapper">
            ...
            <p class="our-services-section__text">
              At our medical website, we offer a range of high-quality services
              to suit your health needs. Our highly qualified doctors are
              available to consult with you and help you choose the best
              treatment options. We pride ourselves on providing personalized
            ...
            <ul class="our-services-section__list">
              ...
              <li class="our-services-section__list-item">
                ...
                <p class="oss-list__text">
                  Upload and store all your medical files and records in one
                  secure place.
                </p>
              </li>
              <li class="our-services-section__list-item">
              ...
              <li class="our-services-section__list-item">
                <img
                  class="oss-list__img"
                  src="img/bottle.svg"
                  alt="Emergency kit icon"
                  width="70"
                  height="80"
                />
                <h3 class="oss-list__heading">Drugs</h3>
                <p class="oss-list__text">
                  Information on different types of medications, their uses and
            ...
            <div class="button-wrapper">
              <a class="our-services-section__button button-white" href="#"
                >Learn more</a
              >
            </div>
          </div>
          ...
          <div class="comment">
            ...
            <div class="comment-bottom">
              <img
                class="comment__img"
                src="img/edward.jpg"
                srcset="img/edward.jpg 1x, img/edward.jpg 2x"
                alt="Edward Newgate"
                width="141"
                height="141"
              />
              ...
              <blockquote class="comment__saying">
